package com.infosys.SpringAOPExample.util;
...
public class LoggingAspect {
	...
	@AfterThrowing("execution(* com.infosys.SpringAOPExample.service.CustomerServiceImpl.fetchCustomer(..))")
	...
	@AfterThrowing(pointcut = "execution(* com.infosys.SpringAOPExample.service.CustomerServiceImpl.fetchCustomer(..))", throwing = "exception")
	public void logAfterThrowingAdviceDetails(JoinPoint joinPoint, Exception exception) {
		logger.info("In After throwing Advice, Joinpoint signature :{}", joinPoint.getSignature());
		logger.error(exception.getMessage(),exception);
	}
	@After("execution(* com.infosys.SpringAOPExample.service.CustomerServiceImpl.fetchCustomer(..))")
	...
	@Before("execution(* com.infosys.SpringAOPExample.service.CustomerServiceImpl.fetchCustomer(..))")
	...
	@AfterReturning(pointcut = "execution(* com.infosys.SpringAOPExample.service.CustomerServiceImpl.fetchCustomer(..))")
	...
	@AfterReturning(pointcut = "execution(* com.infosys.SpringAOPExample.service.CustomerServiceImpl.fetchCustomer(..))", returning = "result")
	...
	@Around("execution(* com.infosys.SpringAOPExample.service.CustomerServiceImpl.fetchCustomer(..))")
